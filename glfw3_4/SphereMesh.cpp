...
// ctor
///////////////////////////////////////////////////////////////////////////////
SphereMesh::SphereMesh(float radius, int sides, bool smooth) : interleavedStride(32)
{
	set(radius, sides, sides/2, smooth);
}
...
// setters
///////////////////////////////////////////////////////////////////////////////
void SphereMesh::set(float radius, int sectors, int stacks, bool smooth)
{
	this->radius = radius;
	...
	Mesh::LoadDataToMeshArrays(vertices , indices);
}
...
void SphereMesh::setSectorCount(int sectors)
{
	set(radius, sectors, stackCount, smooth);
}

void SphereMesh::setStackCount(int stacks)
{
	set(radius, sectorCount, stacks, smooth);
}

void SphereMesh::setSmooth(bool smooth)
{
...
// print itself
///////////////////////////////////////////////////////////////////////////////
void SphereMesh::printSelf() const
{
	std::cout << "===== Sphere =====\n"
		<< "        Radius: " << radius << "\n"
...
///////////////////////////////////////////////////////////////////////////////
void SphereMesh::drawLines(const float lineColor[4]) const
{
	// set line colour
...
// the caller must set the line width before call this
///////////////////////////////////////////////////////////////////////////////
void SphereMesh::drawWithLines(const float lineColor[4]) const
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereMesh::buildVerticesSmooth()
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereMesh::buildVerticesFlat()
{
	const float PI = 3.1415926f;
...
///////////////////////////////////////////////////////////////////////////////
void SphereMesh::addNormal(float nx, float ny, float nz)
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereMesh::addTexCoord(float s, float t)
{
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> SphereMesh::computeFaceNormal(float x1, float y1, float z1,  // v1
